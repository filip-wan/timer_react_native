...
const Timer = ({}) => {
  ...
  return (
    <View>
      ...
      <View style={styles.buttons}>
        <TouchableOpacity onPress={onPressTime(1000 * 1)} style={styles.button}>
          <Text style={styles.text}>{'+1s'}</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={onPressTime(-1000 * 1)}
          style={styles.button}>
          <Text style={styles.text}>{'-1s'}</Text>
        </TouchableOpacity>
      </View>
